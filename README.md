...
- npm
- MongoDB
- mongodb-database-tools, e.g `brew tap mongodb/brew` and then `brew install mongodb-database-tools`
...
- See resulting page in the browser: `https://<your-domain>:3000`, e.g. `http://localhost:3000`
