...
const conn = mongoose
  .connect("mongodb://localhost/video-patterns")
  .then(() => {
    ...
    if (!maintainance) {
      ...
      app.get("/", (req, res) => {
        res.send(
          "<h1>Designing Video Interfaces</h1><ul><li>Interaction Design Patterns for Video Learning Environments</li><li>Database of video-based Learning Environments</li></ul>Page under maintainance due server updates."
        );
      });
